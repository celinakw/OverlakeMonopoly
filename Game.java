...
public class Game{
         ...
         if(bot == false){
            if(i == 0){
               ...
               for(int a = 0; a<gameBoard[i].length-lengthMinus;a++){
                  System.out.println(board[23-a].getName());
            ...
            else if(board[i+grabMod].getName().length()<board[i+opp].getName().length()){
               
               for(int x = 0; x < (board[i+opp].getName().length()-board[i].getName().length())/2+1; x++){
                  temp +=" ";
               }
               gameBoard[2][i+collumnMod] = temp+board[i].getName()+temp;
               while(gameBoard[2][i+collumnMod].length()!=(board[i+opp].getName().length())){
                  if(gameBoard[2+rowMod][i+collumnMod].length()>(board[i+opp].getName().length())){
                     gameBoard[2+rowMod][i+collumnMod]=gameBoard[2+rowMod][i+collumnMod].substring(0,gameBoard[2+rowMod][i+collumnMod].length()-2);
                  }
                  else if(gameBoard[2+rowMod][i+collumnMod].length()<(board[i+opp].getName().length())){
                     gameBoard[2+rowMod][i+collumnMod]+=" ";
                  }
               }
            }
   ...
   public static void main(String args[]){
      ...
      Place squareOne = new Place("Go! 0", null, 0, 0, false);//corner
      ...
      Place squareSeven= new Place("SRB", null, 0, 0, false, "jail");//corner
      ...
      Place squareThirteen= new Place("Flagpole", null, 0, 0, false);//corner
      ...
      Place squareNineteen= new Place("Go to SRB", null, 0, 0, false, "gojail");//corner
